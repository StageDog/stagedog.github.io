...
➡️ **直接下载:** {lolodesu}`罗落大陆 <src/罗落大陆/罗落大陆.png>`
...
➡️ **直接下载:** {lolodesu}`有点奇怪的新同桌 <src/白川璃/白川璃.png>`
...
➡️ **直接下载:** {lolodesu}`男user版 <src/郁娇病娇小猫娘/男user版.png>` / {lolodesu}`女user版 <src/郁娇病娇小猫娘/女user版.png>` / {lolodesu}`Dark <src/郁娇病娇小猫娘/Dark.png>` / {lolodesu}`Seul <src/郁娇病娇小猫娘/Seul.png>`

### 😈 魔王与勇者在现代社会终于放下了争端

➡️ **前置插件:** [酒馆助手](https://github.com/N0VI028/JS-Slash-Runner)、[提示词模板](https://github.com/zonde306/ST-Prompt-Template) \
➡️ **角色卡发布页:** [旅程](https://discord.com/channels/1291925535324110879/1379005638218350613)
➡️ **直接下载:** {lolodesu}`魔王与勇者在现代社会终于放下了争端 <src/魔王与勇者放下争端/魔王与勇者放下争端.png>`
...
➡️ **直接下载:** {lolodesu}`会喵喵叫的宠物妹妹 <src/会喵喵叫的宠物妹妹/会喵喵叫的宠物妹妹.png>`
