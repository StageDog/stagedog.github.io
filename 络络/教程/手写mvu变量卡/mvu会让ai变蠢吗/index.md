...
变量输出格式
: 它对应于状态栏提示词中对好感度部分的输出要求, 无论如何都得写, 而显然 MVU 变量框架所要输出的格式比起状态栏更简单. 至于 `<update_analysis>` 即思维链部分, 其实[部分用状态栏的角色卡](https://discord.com/channels/1134557553011998840/1291999036353810442)也会使用思维链来稳定格式和更新好感度, 也只是可选项.
