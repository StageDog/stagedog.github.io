...
- 针对 1.13.4 及以上的酒馆版本, 你可以在条目内容开头加上一行 `@@preprocessing` 来要求提示词模板在世界书激活前处理这个条目. 这样一来, 这个条目的内容在激活前已经变成`【今天阳光明媚，适合出门散步】`、`【外面下着雨，记得带伞】`或`【今天天气一般】`中的一种, 能正确激活绿灯, 支持黏性、冷却等时效功能.
