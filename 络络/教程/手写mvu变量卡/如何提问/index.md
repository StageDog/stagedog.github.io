...
### 日志查看器中出现黄色的 `【脚本|变量结构】第x条开场白的变量初始化失败`
...
比如……你的角色卡支持中途新增角色, 你又给每个角色设计了几十个变量, 那么 AI 在为新角色设置变量时很可能遗漏某些变量, 从而无法成功新增角色.
...
- 电脑上, {menuselction}`f12 --> console (控制台)` 截图所有红色报错;
